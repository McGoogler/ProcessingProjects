...
public class dream_catcher extends PApplet {
...
float orbit=0;
float orbit2=0;
float orbitSpeed=.01f;
float orbit2Speed=.03f;
...
public void setup() {
  ...
  redInc =random(.01f, 2.5f);
  greenInc=random(.01f, 2.5f);
  blueInc=random(.01f, 2.5f);
}
...
public boolean overCircle(int x, int y, int diameter) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "dream_catcher" };
    if (passedArgs != null) {
