...
public class binary_grid extends PApplet {
...
public void Ysystem (float sx, float sy, float ex, float ey, int angle, int level)
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "binary_grid" };
    if (passedArgs != null) {
